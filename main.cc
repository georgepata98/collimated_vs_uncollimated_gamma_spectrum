...
{
    G4int nOfRuns = 1;  // de selectat nr. de Run-uri
    G4bool visualization = false;  // true = cu vizualizare si false = fara vizualizare

    G4int visEvents = 15;  // nr. events cu GUI
    // G4int eventsPerRun = 2000000000;  // nr. ~maxim care depinde de int
